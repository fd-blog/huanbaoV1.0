<template>
    <div class="stbh wrapper">
        <div class="left animated bounceInLeft">
            <div class="left_top">
                <a class="title" href="javascript:;" target="_self">生态红线</a>
                <div class="main">
                    <div class="inner">
            ...
            <div class="left_bottom">
                <a class="title" href="javascript:;" target="_self">生态环境指数</a>
                <div class="main">
                    <div class="inner">
                        <img src="../../assets/img/wait.png" alt="">
                        <span>静待开发</span>
        ...
        <div class="wrapper_middle middle animated bounceInDown">
            <div class="wrapper_middle_top" id="stbhMap">
                <img src="../../assets/img/mapImg.png" alt="" style="width:100%; height:115%;margin-top:-5%">
            </div>
            <div class="wrapper_middle_bottom ">
                <a class="title" href="javascript:;" target="_self">自然保护区</a>
                <div class="main">
                    <div class="inner">
                        <img src="../../assets/img/wait.png" alt="">
                        <span>静待开发</span>
        ...
        <div class="right animated bounceInRight">
            <div class="right_top">
                <a class="title" href="javascript:;" target="_self">生态文明建设县市</a>
                <div class="main">
                    <div class="inner">
                        <img src="../../assets/img/wait.png" alt="">
                        <span>静待开发</span>
            ...
            <div class="right_bottom">
                <a class="title" href="javascript:;" target="_self">生态文明示范区</a>
                <div class="main">
                    <div class="inner">
                        <img src="../../assets/img/wait.png" alt="">
                        <span>静待开发</span>
...
export default {
    ...
    mounted() {
        ...
        // mapChart = echarts.init(document.getElementById('stbhMap'))
