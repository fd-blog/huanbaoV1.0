<template>
    <div class="zyhbjc wrapper">
        ...
        <div class="wrapper_middle middle animated bounceInDown">
            <div class="wrapper_middle_top" id="zyhbjcMap"></div>
...
<style lang="scss">
@import './../../assets/scss/zyhbjc.scss';
</style>
<script>
export default {
    data() {
    ...
    mounted() {
        ...
        mapChart = echarts.init(document.getElementById('zyhbjcMap'))
